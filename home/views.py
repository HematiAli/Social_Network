...
from .forms import PostCreateUpdateForm, CommentCreationForm, CommentReplyForm, PostSearchForm
...
class PostDetailView(View):
    ...
    def post(self, request, *args, **kwargs):
        ...
        if form.is_valid():
            ...
            new_comment.save()
            messages.success(request, 'your comment submitted successful', 'success')
...
class PostAddReplyView(LoginRequiredMixin, View):
    ...
    def post(self, request, post_id, comment_id):
        ...
        if form.is_valid():
            ...
            reply.is_reply = True
            reply.save()
            messages.success(request, 'you reply submitted successful', 'success')
        return redirect('home:post_detail', post.id, post.slug)
